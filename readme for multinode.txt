...
Step 2. (for master) When you open the terminal you are in the home directory, paste this command
        in your terminal : "wget https://raw.githubusercontent.com/anmolpal/One-Click/main/OneClickMasterMultinode.sh"
...
Step 11.(on your slave server) Now open your slave servers using SSH as we have done in Step1 and use 
        your slave server IP and the username, password to login. 
        In your home director directory paste this command
         "sudo wget https://github.com/anmolpal/One-Click.git" and type this command
         "bash One Click Slave Multinode.sh" and perform step number 4,5,6,7,9 as we have already done 
         in our master server.  
       
Step 12.(on master) Type the command "source ~/.bashrc".
         Now open a new terminal and do again "bash One Click Master Multinode.sh"
